...
@Component({
  selector: 'kt-modal-see-more',
  templateUrl: './modal-see-more.component.html',
  styleUrls: ['./modal-see-more.component.scss']
})
export class ModalSeeMoreComponent implements OnInit, OnDestroy {
  gridApi: any;
  gridColumnApi: any;
  rows = [];
  rowsToDisplay = [];
  ...
  destroy$ = new Subject();
  constructor(public ref: MatDialogRef<ModalSeeMoreComponent>,
